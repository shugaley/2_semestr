...
p_dec_rep:      xor rdx, rdx
                div r10

                add rdx, '0'           ;ASCII number
                mov [buf + r13], dl   ;ASCII to buffer
...
p_hex_rep:      xor rdx, rdx
                div r10

                cmp rdx, 9
                jbe rep1

                add rdx, '7'           ;ASCII number 7 = A - 10
                jmp rep2

rep1:           add rdx, '0'           ;ASCII number

rep2:           mov [buf + r13], dl    ;ASCII to buffer
